# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 12:41:38 2016
...
plt.plot(tpol, interpNewton(t,g,tpol), 'b-', label = 'Polinomio de Primeira ordem' )
plt.legend()
plt.grid()
plt.xlabel('$t$ (em ms)')
plt.title('Gráfico da Interpolacao Polinomial de Primeira Ordem')
plt.show()